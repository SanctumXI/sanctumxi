describe('Sanctum weapon skill balance adjustments', function()
    ...
    before_each(function()
        ...
        applyModule('modules/sanctum/CombatRework/Lua/WeaponSkills/balance_adjustments.lua')
    end)
    ...
    it('applies the requested hand-to-hand formulas', function()
        ...
        params = physical(xi.weaponskill.DRAGON_KICK, { atkVaries = { 1.15, 1.25, 1.35 } })
        assertTriplet(params.ftpMod, 1.5, 2.0, 2.5)
        assertTriplet(params.atkVaries, 1.15, 1.25, 1.35)
        ...
        assert(params.str_wsc == 0.6 and params.multiHitfTP)
