...
xi.mob.phOnDespawn = function(ph, phNmId, chance, cooldown, params)
    ...
    SetServerVariable(string.format("[LOTTOBONUS]%s", nmId), GetServerVariable(string.format("[LOTTOBONUS]%s", nmId)) + 1)
    local bonuschance = GetServerVariable(string.format("[LOTTOBONUS]%s", nmId))
