...
xi.shop.generalGuildStock =
{
    ...
    [xi.skill.CLOTHCRAFT] =
    {
        ...
        { xi.item.SPOOL_OF_GOLD_THREAD,      18500, xi.craftRank.CRAFTSMAN  },
    ...
    [xi.skill.GOLDSMITHING] =
    {
        ...
        { xi.item.CHUNK_OF_ZINC_ORE,          400, xi.craftRank.AMATEUR    },
        { xi.item.CHUNK_OF_COPPER_ORE,         12, xi.craftRank.AMATEUR    },
        { xi.item.BRASS_NUGGET,                40, xi.craftRank.RECRUIT    },
        { xi.item.BRASS_SHEET,                400, xi.craftRank.RECRUIT    },
        { xi.item.CHUNK_OF_SILVER_ORE,        550, xi.craftRank.RECRUIT    },
        { xi.item.SILVER_NUGGET,              250, xi.craftRank.INITIATE   },
        ...
        { xi.item.CHUNK_OF_MYTHRIL_ORE,      3500, xi.craftRank.NOVICE     },
        { xi.item.CHUNK_OF_GOLD_ORE,         9000, xi.craftRank.APPRENTICE },
        ...
        { xi.item.CHUNK_OF_ALUMINUM_ORE,    10000, xi.craftRank.APPRENTICE },
        { xi.item.GOLD_SHEET,               32000, xi.craftRank.JOURNEYMAN },
        { xi.item.GOLD_CHAIN,               58000, xi.craftRank.JOURNEYMAN },
        { xi.item.CHUNK_OF_PLATINUM_ORE,     24000, xi.craftRank.CRAFTSMAN  },
    ...
    [xi.skill.SMITHING] =
    {
        ...
        { xi.item.CHUNK_OF_DARKSTEEL_ORE,       9000, xi.craftRank.JOURNEYMAN },
...
xi.shop.handleValerianoShop = function(player, npc)
    ...
    local stock =
    {
        ...
        { xi.item.SCROLL_OF_MAGES_BALLAD_II, 94039 },
    }
