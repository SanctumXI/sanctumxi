...
{
    ['accelerator'        ] = { { modifier = xi.mod.EVA,                         values = {     5,    10,    15,    25 }, opticFiber = true  }, },
    ['accelerator_ii'     ] = { { modifier = xi.mod.EVA,                         values = {    10,    15,    20,    30 }, opticFiber = true  }, },
    ...
    ['armor_plate_ii'     ] = { { modifier = xi.mod.DMGPHYS,                     values = { -1500, -2000, -2500, -3000 }, opticFiber = true  }, },
    ...
    ['coiler_ii'          ] = { { modifier = xi.mod.DOUBLE_ATTACK,               values = {     5,    10,    20,    30 }, opticFiber = true  }, },
    ['damage_gauge'       ] = { { modifier = xi.mod.AUTO_HEALING_THRESHOLD,      values = {    50,    60,    70,    80 }, opticFiber = false },
                                { modifier = xi.mod.AUTO_HEALING_DELAY,          values = {     2,     2,     2,     2 }, opticFiber = false }, },
    ...
    ['galvanizer'         ] = { { modifier = xi.mod.COUNTER,                     values = {     0,    10,    25,    40 }, opticFiber = true  }, },
    ['hammermill'         ] = { { modifier = xi.mod.SHIELD_BASH,                 values = {    25,    35,    60,   110 }, opticFiber = true  },
                                { modifier = xi.mod.AUTO_SHIELD_BASH_SLOW,       values = {     0,    14,    21,    28 }, opticFiber = true  }, },
    ...
    ['mana_conserver'     ] = { { modifier = xi.mod.CONSERVE_MP,                 values = {    20,    30,    45,    60 }, opticFiber = true  }, },
    ...
    ['optic_fiber_ii'     ] = { { modifier = xi.mod.AUTO_PERFORMANCE_BOOST,      values = {    20,    30,    40,    50 }, opticFiber = false }, },
    ['percolator'         ] = { { modifier = xi.mod.COMBAT_SKILLUP_RATE,         values = {     5,    10,    20,    30 }, opticFiber = true  }, },
    ['power_cooler'       ] = { { modifier = xi.mod.MP_COST_REDUCTION,           values = {    10,    20,    35,    50 }, opticFiber = true  }, },
    ['repeater'           ] = { { modifier = xi.mod.DOUBLE_SHOT_RATE,            values = {     5,    10,    30,    60 }, opticFiber = true  }, },
    ['resister'           ] = { { modifier = xi.mod.STATUSRES,                   values = {    10,    20,    40,    60 }, opticFiber = true  }, },
    ...
    ['smoke_screen'       ] = { { modifier = xi.mod.EVA,                         values = {    10,    30,    50,   160 }, opticFiber = true  },
                                { modifier = xi.mod.ACC,                         values = {   -10,   -30,   -50,  -150 }, opticFiber = true  },
                                { modifier = xi.mod.RACC,                        values = {   -10,   -30,   -50,  -150 }, opticFiber = true  },
                                { modifier = xi.mod.ENMITY,                      values = {     0,   -30,   -50,   -80 }, opticFiber = true  }, },
    ['stabilizer'         ] = { { modifier = xi.mod.ACC,                         values = {     5,    10,    15,    20 }, opticFiber = true  }, },
    ['stabilizer_ii'      ] = { { modifier = xi.mod.ACC,                         values = {    10,    20,    30,    40 }, opticFiber = true  }, },
    ...
    ['steam_jacket'       ] = { { modifier = xi.mod.AUTO_STEAM_JACKET_REDUCTION, values = {    20,    40,    60,    80 }, opticFiber = false  }, },
    ['strobe'             ] = { { modifier = xi.mod.ENMITY,                      values = {    25,    40,    50,    60 }, opticFiber = true  }, },
    ['strobe_ii'          ] = { { modifier = xi.mod.ENMITY,                      values = {    25,    40,    50,    60 }, opticFiber = true  }, },
    ['tactical_processor' ] = { { modifier = xi.mod.AUTO_DECISION_DELAY,         values = {    50,   150,   225,   300 }, opticFiber = false }, },
    ...
    ['vivi-valve'         ] = { { modifier = xi.mod.CURE_POTENCY,                values = {     5,    15,    30,    50 }, opticFiber = true  }, },
...
xi.automaton.repairKit =
{
    frameDivisors =
    {
        ...
        [xi.automaton.frame.VALOREDGE ] = 20,
    ...
    data =
    {
        ['auto-repair_kit'    ] = { id = 193, hpBoost = 1, regenBase = { 1,  2,  4,  7 }, regenMultiplier = { 0, 0.125, 0.225, 0.375 } },
        ['auto-repair_kit_ii' ] = { id = 196, hpBoost = 2, regenBase = { 1,  4,  8, 13 }, regenMultiplier = { 0, 0.600, 1.200, 1.800 } },
        ['auto-repair_kit_iii'] = { id = 202, hpBoost = 3, regenBase = { 1,  9, 12, 15 }, regenMultiplier = { 0, 1.800, 2.400, 3.000 } },
        ['auto-repair_kit_iv' ] = { id = 205, hpBoost = 4, regenBase = { 1, 15, 18, 21 }, regenMultiplier = { 0, 3.000, 3.600, 4.200 } },
    },
}
