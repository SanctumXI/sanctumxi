...
xi.battlefield.id =
{
    ...
    THREES_A_CROWD                             = 133, -- Chamber of Oracles, index 11
    ...
    DRAGON_SCALES                              = 201,
    THE_RAVENING_WORM                          = 202, -- Sacrificial Chamber, index 7
...
{
    [xi.item.WARRIORS_TESTIMONY]      = 2,
    [xi.item.MONKS_TESTIMONY]         = 2,
    [xi.item.WHITE_MAGES_TESTIMONY]   = 2,
    [xi.item.BLACK_MAGES_TESTIMONY]   = 2,
    [xi.item.RED_MAGES_TESTIMONY]     = 2,
    [xi.item.THIEFS_TESTIMONY]        = 2,
    [xi.item.PALADINS_TESTIMONY]      = 2,
    [xi.item.DARK_KNIGHTS_TESTIMONY]  = 2,
    [xi.item.BEASTMASTERS_TESTIMONY]  = 2,
    [xi.item.BARDS_TESTIMONY]         = 2,
    [xi.item.RANGERS_TESTIMONY]       = 2,
    [xi.item.SAMURAIS_TESTIMONY]      = 2,
    [xi.item.NINJAS_TESTIMONY]        = 2,
    [xi.item.DRAGOONS_TESTIMONY]      = 2,
    [xi.item.SUMMONERS_TESTIMONY]     = 2,
    [xi.item.BLUE_MAGES_TESTIMONY]    = 2,
    [xi.item.CORSAIRS_TESTIMONY]      = 2,
    [xi.item.PUPPETMASTERS_TESTIMONY] = 2,
    [xi.item.DANCERS_TESTIMONY] = 2,
}
