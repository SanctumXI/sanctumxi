...
-- TH lvl    VC    C     UC    R     VR    SR   UR
    [ 0] = { 2400, 1500, 1000,  500,  200,  50,  10 },
    [ 1] = { 4800, 3000, 1200,  600,  250,  75,  20 },
    [ 2] = { 5600, 4000, 1500,  700,  300, 100,  30 },
    [ 3] = { 6000, 4250, 1750,  850,  350, 120,  35 },
    [ 4] = { 6400, 4500, 2000,  1000, 500, 140,  40 },
