...
zones[xi.zone.KORROLOKA_TUNNEL] =
{
    text =
    {
        ...
        ENTERED_SPRING                = 7345,  -- The water in this spring is pleasant and tepid. This looks like a nice place to warm yourself up.
        LEFT_SPRING_EARLY             = 7346,  -- You are not warm enough yet. You will need to spend more time than that in the spring to get your body heated up.
        LEFT_SPRING_CLEAN             = 7347,  -- Your whole body is piping hot, and the smell of the Rafflesia pollen is gone!
        MORION_WORM_1                 = 7350,  -- It appears to be a hole made by some kind of animal. Fragments of iron ore are scattered around the area...
        FILL_FLASK                    = 7353,  -- You carefully draw the water stored in the clam into <keyitem>.
        STILL_LIGHT                   = 7354,  -- The flask still feels light...
        FLASK_FULL                    = 7355,  -- <item> is now full!
        CLAM_EMPTY                    = 7356,  -- The clam is empty.
        REGIME_REGISTERED             = 9478,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 10530, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 10531, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 10532, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 10533, -- You already possess that temporary item.
        NO_COMBINATION                = 10538, -- You were unable to enter a combination.
