...
entity.onTrigger = function(player, npc)
    local stock =
    {
        ...
        { xi.item.BAG_OF_SAN_DORIAN_FLOUR,    62, 3, },
        { xi.item.BAG_OF_SEMOLINA,          2080, 3, },
        { xi.item.POT_OF_MAPLE_SUGAR,         41, 3, },
        { xi.item.STICK_OF_CINNAMON,         270, 3, },
        { xi.item.EAR_OF_MILLIONCORN,         49, 3, },
        { xi.item.CHUNK_OF_ROCK_SALT,         16, 3, },
        { xi.item.FLASK_OF_DISTILLED_WATER,   12, 3, },
        { xi.item.SPRIG_OF_CIBOL,            228, 3, },
        { xi.item.ZUCCHINI,                  511, 3, },
        { xi.item.CLUSTER_OF_PAPRIKA,        590, 3, },
    }
