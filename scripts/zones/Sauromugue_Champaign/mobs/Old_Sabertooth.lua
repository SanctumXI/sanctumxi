...
local pathNodes =
{
    ...
    { x = 671.028, y =  -9.169, z = -345.759, rotation = 043,  wait =  100 }, -- Turns around and runs to the next spot
    ...
    { x = 662.475, y =  -9.715, z = -333.734, rotation = 162,  wait =  100 }, -- Turns around and runs to the next spot
    { x = 666.871, y =  -9.506, z = -338.418, rotation = 033, wait =  10000 },
    { x = 671.712, y =  -9.001, z = -346.989, rotation = 043, wait =  10000 },
    { x = 677.547, y = -10.064, z = -361.535, rotation = 075,  wait =  100 }, -- Gateway waypoint so it doesn't path through the wall
