...
zones[xi.zone.DEN_OF_RANCOR] =
{
    text =
    {
       ITEM_CANNOT_BE_OBTAINED       = 6385,  -- You cannot obtain the <item>. Come back after sorting your inventory.
        ...
        FIVE_DRIED_EYEBALLS           = 7373,  -- Five dried eyeballs are stuck to the surface of the rock...
        ...
        HOMEPOINT_SET                 = 10558, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 10616, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
