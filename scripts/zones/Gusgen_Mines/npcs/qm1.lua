...
entity.onTrigger = function(player, npc)
    ...
    if
        ...
        npcUtil.popFromQM(player, npc, ID.mob.AROMA_FLY, { claim = true, hide = 600, look = true, radius = 1 })
    then
        ...
        npcUtil.queueMove(npc, npcUtil.pickNewPosition(npc:getID(), aromaFlySpawnPoints))
    else
