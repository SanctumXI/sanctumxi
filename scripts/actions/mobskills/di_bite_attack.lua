...
-- Family: Monoceros
-- Notes: Has basic autoattack-style messages, consumes no TP, and applies Weight effect
...
mobskillObject.onMobWeaponSkill = function(mob, target, skill, action)
    ...
    if xi.mobskills.processDamage(mob, target, skill, action, info) then
        ...
        xi.mobskills.mobStatusEffectMove(mob, target, xi.effect.WEIGHT, 50, 0, math.randomInt(3, 15)) -- TODO: Capture power
    end
