-----------------------------------
-- Pre-WotG sword weapon-skill extensions
-- Era baseline: 2007-11-19 (one day before the WotG release)
-----------------------------------
require('modules/module_utils')
-----------------------------------

local moduleName = 'sanctum_combat_pre_wotg_sword_extensions'
