-----------------------------------
-- Sanctum combat rework: monster TP-move calculations
...
local function handleSinglePhysicalHit(mob, target, baseHitDamage, params)
    ...
    then
        ...
        xi.job_utils.paladin.restoreShieldMasteryMP(target)
    end
...
local sanctumModule = Module:new('sanctum_combat_mobskill_calculations')
