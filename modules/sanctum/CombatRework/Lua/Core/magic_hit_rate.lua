-----------------------------------
-- Sanctum combat rework: magic hit-rate calculations
-- Source: scripts/globals/combat/magic_hit_rate.lua
...
{
    ['xi.combat.magicHitRate.calculateResistRate'] = xi.combat.magicHitRate.calculateResistRate,
}

local sanctumModule = Module:new('sanctum_combat_magic_hit_rate')
