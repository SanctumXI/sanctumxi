-----------------------------------
-- Sanctum combat rework: Dragoon jump calculations
-- Source: scripts/globals/job_utils/dragoon.lua
...
{
    ['xi.job_utils.dragoon.useJump'] = xi.job_utils.dragoon.useJump,
    ['xi.job_utils.dragoon.useHighJump'] = xi.job_utils.dragoon.useHighJump,
    ['xi.job_utils.dragoon.useSpiritJump'] = xi.job_utils.dragoon.useSpiritJump,
    ['xi.job_utils.dragoon.useSoulJump'] = xi.job_utils.dragoon.useSoulJump,
}

local sanctumModule = Module:new('sanctum_combat_dragoon')
