-----------------------------------
-- Sanctum combat rework: Summoner avatar damage calculations
-- Source: scripts/globals/summon.lua
...
{
    ['xi.summon.avatarFinalAdjustments'] = xi.summon.avatarFinalAdjustments,
}

local sanctumModule = Module:new('sanctum_combat_summoner')
