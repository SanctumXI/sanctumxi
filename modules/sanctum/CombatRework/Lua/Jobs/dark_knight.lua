-----------------------------------
-- Sanctum combat rework: Dark Knight ability calculations
-- Source: scripts/globals/job_utils/dark_knight.lua
...
{
    ['xi.job_utils.dark_knight.useWeaponBash'] = xi.job_utils.dark_knight.useWeaponBash,
}

local sanctumModule = Module:new('sanctum_combat_dark_knight')
