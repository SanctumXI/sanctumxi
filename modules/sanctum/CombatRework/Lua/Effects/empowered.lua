-----------------------------------
-- Sanctum weapon-skill empowerment status effect
-- Source: scripts/effects/empowered.lua
-----------------------------------
require('modules/module_utils')
-----------------------------------

xi.module.ensureTable('xi.effects.empowered')

local sanctumModule = Module:new('sanctum_combat_empowered_effect')
...
sanctumModule:addOverride('xi.effects.empowered.onEffectGain', effectObject.onEffectGain)
sanctumModule:addOverride('xi.effects.empowered.onEffectTick', effectObject.onEffectTick)
sanctumModule:addOverride('xi.effects.empowered.onEffectLose', effectObject.onEffectLose)
