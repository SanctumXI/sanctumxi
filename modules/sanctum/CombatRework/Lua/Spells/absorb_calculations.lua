-----------------------------------
-- Sanctum combat rework: Absorb and drain spell calculations
-- Source: scripts/globals/spells/absorb_spell.lua
...
{
    ['xi.spells.absorb.doAbsorbStatSpell'] = xi.spells.absorb.doAbsorbStatSpell,
    ['xi.spells.absorb.doDrainingSpell'] = xi.spells.absorb.doDrainingSpell,
    ['xi.spells.absorb.doAbsorbTPSpell'] = xi.spells.absorb.doAbsorbTPSpell,
    ['xi.spells.absorb.doAbsorbAttriSpell'] = xi.spells.absorb.doAbsorbAttriSpell,
}

local sanctumModule = Module:new('sanctum_combat_absorb_calculations')
