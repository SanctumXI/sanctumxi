...
UPDATE `mob_pools` SET `modelSize` = 1, `modelHitboxSize` = 12 WHERE `poolid` IN (4346, 4348, 4381, 4527, 4565, 4685, 4729, 5474, 5475, 5500, 5507, 5511, 5536, 5601, 5635, 5636, 5651, 5652, 5681, 5683, 5723, 5724, 5761, 5776, 5787, 5800, 5814, 5866, 5876, 5953, 5954, 5956, 5957, 6004, 6008, 6083, 6101, 6110, 6115);
...
UPDATE `mob_pools` SET `modelSize` = 1, `modelHitboxSize` = 15 WHERE `poolid` IN (4422, 4434, 4435, 4449, 4451, 4472, 4494, 4495, 4496, 4499, 4510, 4512, 4520, 4832, 4942, 5346, 5420, 5554, 5557, 5766, 5774, 5785, 5815, 5827, 5847, 6060, 6062, 6063, 6068, 6088, 6098, 6099, 6144, 6320, 6680, 6681, 6972, 6974, 6978);
...
UPDATE `mob_pools` SET `modelSize` = 0, `modelHitboxSize` = 20 WHERE `poolid` IN (579, 580, 581, 612, 613, 821, 822, 823, 1592, 3383, 3840, 4259, 4491, 4686, 7004);
...
UPDATE `mob_pools` SET `modelSize` = 1, `modelHitboxSize` = 16 WHERE `poolid` IN (373, 1590, 1829, 2087, 2539, 3666, 5214);
