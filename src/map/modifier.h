...
enum class Mod
{
    ...
    AUGMENT_KILLER_EFFECTS = 1212, // Augments "Killer" effects (Examples: Ferine Gausape +1 and +2)
    ...
    SAVAGE_BLADE_ENMITY = 1208, // Sanctum: Increases enmity generated by 25% during Savage Blade empowerment
    SAVAGE_BLADE_DAMAGE = 1209, // Sanctum: Damage dealt bonus for normal melee and ranged attacks
    MAGIC_BURST_MP = 1221, // Sanctum: Restores this percent of a spell's base MP cost after a magic burst
    TACTICS = 1222, // Sanctum: Grants 5 TP per point after a successful block or guard
    BUFF_DURATION = 1223, // Sanctum: Adds this many seconds to eligible allied buffs applied by the wearer
    PROC_RATE = 1224, // Sanctum: Adds percentage points to weapon additional-effect proc rates
    SKILLCHAIN_TP = 1225, // Sanctum: Grants 10 TP per point when the wearer closes a skillchain
    RECAST_RATE = 1226, // Sanctum: Subtracts this many seconds from spell and job-ability recasts

    // The spares take care of finding the next ID to use so long as we don't forget to list IDs that have been freed up by refactoring.
    // 570 through 825 used by WS DMG mods these are not spares.
    //
    // SPARE IDs: 938, 1227 and onward
};
