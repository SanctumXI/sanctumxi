...
enum MERIT_TYPE
{
    ...
    MERIT_IRON_GUARD_EFFECT = MCATEGORY_MNK_1 + 0x02,
    ...
    MERIT_SATA_RECAST         = MCATEGORY_THF_1 + 0x04,
    MERIT_BULLY_RECAST        = MCATEGORY_THF_1 + 0x06,
    MERIT_TRIPLE_ATTACK_RATE  = MCATEGORY_THF_1 + 0x08,

    // PLD 1
    MERIT_MAJESTY_RECAST      = MCATEGORY_PLD_1 + 0x00,
    MERIT_CHALLENGE           = MCATEGORY_PLD_1 + 0x02,
    MERIT_SENTINEL_RECAST     = MCATEGORY_PLD_1 + 0x04,
    MERIT_SHIELD_CHANCE       = MCATEGORY_PLD_1 + 0x06,
    MERIT_RAMPART_RECAST      = MCATEGORY_PLD_1 + 0x08,

    // DRK 1
    MERIT_SOULEATER_RECAST     = MCATEGORY_DRK_1 + 0x00,
    MERIT_NETHER_VOID          = MCATEGORY_DRK_1 + 0x02,
    ...
    MERIT_PET_BOOST         = MCATEGORY_BST_1 + 0x04,
    MERIT_READY_BUFF        = MCATEGORY_BST_1 + 0x06,
    ...
    MERIT_VELOCITY_SHOT_EFFECT  = MCATEGORY_RNG_1 + 0x02,
    MERIT_BARRAGE_EFFECT        = MCATEGORY_RNG_1 + 0x04,
    MERIT_DOUBLE_SHOT_EFFECT    = MCATEGORY_RNG_1 + 0x06,
    MERIT_RAPID_SHOT_RATE       = MCATEGORY_RNG_1 + 0x08,

    // SAM 1
    MERIT_THIRD_EYE_RECAST      = MCATEGORY_SAM_1 + 0x00,
    MERIT_SEKKANOKI_RECAST      = MCATEGORY_SAM_1 + 0x02,
    ...
    MERIT_NINJUTSU_EFFECT      = MCATEGORY_NIN_1 + 0x02,
    MERIT_HOJO_EFFECT          = MCATEGORY_NIN_1 + 0x04,
    MERIT_JUBAKU_EFFECT        = MCATEGORY_NIN_1 + 0x06,
    MERIT_KURAYAMI_EFFECT      = MCATEGORY_NIN_1 + 0x08,
    MERIT_DOKUMORI_EFFECT      = MCATEGORY_NIN_1 + 0x0A,
    MERIT_DUAL_WIELD_BONUS     = MCATEGORY_NIN_1 + 0x0C,

    // DRG 1
    MERIT_CONSERVE_TP_CHANCE    = MCATEGORY_DRG_1 + 0x00,
    MERIT_JUMP_RECAST           = MCATEGORY_DRG_1 + 0x02,
    MERIT_WYVERN_BOOST          = MCATEGORY_DRG_1 + 0x04,
    MERIT_WYVERN_HP             = MCATEGORY_DRG_1 + 0x06,
    ...
    // BLU 1
    MERIT_AFFINITY_RECAST       = MCATEGORY_BLU_1 + 0x00,
    MERIT_CONSERVE_MP_EFFECT    = MCATEGORY_BLU_1 + 0x02,
    ...
    MERIT_RAPID_SHOT_RATE2    = MCATEGORY_COR_1 + 0x08,

    // PUP 1
    MERIT_MARTIAL_ARTS_EFFECT   = MCATEGORY_PUP_1 + 0x00,
    MERIT_CASTER_PROTOCOL       = MCATEGORY_PUP_1 + 0x02,
    MERIT_DEFENDER_PROTOCOL     = MCATEGORY_PUP_1 + 0x04,
    MERIT_MEDIC_PROTOCOL        = MCATEGORY_PUP_1 + 0x06,
    MERIT_STRIKER_PROTOCOL      = MCATEGORY_PUP_1 + 0x08,
    ...
    MERIT_MODUS_VERITAS_EFFECT   = MCATEGORY_SCH_1 + 0x02,
    ...
    MERIT_BLOOD_DISCIPLINE = MCATEGORY_DRK_2 + 0x04,
    MERIT_DESPERATE_BLOWS  = MCATEGORY_DRK_2 + 0x06,

    // BST 2
    MERIT_RUN_WILD        = MCATEGORY_BST_2 + 0x00,
    ...
    MERIT_TACTICAL_SWITCH  = MCATEGORY_PUP_2 + 0x02,
    MERIT_REPAIR_MAINTAIN  = MCATEGORY_PUP_2 + 0x04,
    MERIT_OVERCLOCKING     = MCATEGORY_PUP_2 + 0x06,
