...
auto CLuaBaseEntity::handleFanDance(int32 damage) -> int32
{
    if (auto* PBattle = dynamic_cast<CBattleEntity*>(m_PBaseEntity))
    {
        return battleutils::HandleFanDance(PBattle, damage);
    }
...
void CLuaBaseEntity::Register()
{
    ...
    SOL_REGISTER("handleFanDance", CLuaBaseEntity::handleFanDance);
